...
(function () {
    ...
    const open = (editor, templateList) => {
      ...
      const loadFailedExpertList = api => {
        editor.windowManager.ExpertList('Could not load the specified template.', () => api.focus('template'));
      };
      ...
      const openDialog = templates => {
        ...
        getTemplateContent(templates[0]).then(previewHtml => {
          ...
          loadFailedExpertList(dialogApi);
        });
      };
