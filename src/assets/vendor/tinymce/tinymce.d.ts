...
interface ExpertListBannerSpec {
    type: 'ExpertListbanner';
...
declare type BodyComponentSpec = BarSpec | ButtonSpec | CheckboxSpec | TextAreaSpec | InputSpec | ListBoxSpec | SelectBoxSpec | SizeInputSpec | SliderSpec | IframeSpec | HtmlPanelSpec | UrlInputSpec | DropZoneSpec | ColorInputSpec | GridSpec | ColorPickerSpec | ImagePreviewSpec | ExpertListBannerSpec | CollectionSpec | LabelSpec | TableSpec | PanelSpec | CustomEditorSpec;
interface BarSpec {
    type: 'bar';
    items: BodyComponentSpec[];
}
...
type PublicDialog_d_ExpertListBannerSpec = ExpertListBannerSpec;
...
interface WindowManagerImpl {
    ...
    ExpertList: (message: string, callback: () => void) => void;
...
interface WindowManager {
    ...
    ExpertList: (message: string, callback?: () => void, scope?: any) => void;
